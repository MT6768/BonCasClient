...
//////////////////////////////////////////////////////////////////////
// 不揮発性 CStringArray データ型
//////////////////////////////////////////////////////////////////////

class CConfigStringArray : public CConfigData, public CStringArray
{
public:
	CConfigStringArray();
	CConfigStringArray(const UINT nSection, LPCTSTR lpszKeyNameBase);
	virtual ~CConfigStringArray();
